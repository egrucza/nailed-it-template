...
function App() {
  ...
  function scrollBees() {
    ...
    if (scrollbar) {
      ...
      var newValue = parseFloat(top) + 0.2;
      if (newValue <= 250) {
        const newTopStyle = `${newValue}px`;
  ...
  return (
    <div className="app">
      <nav className="app-nav">
        ...
        <a onClick={beeMovieCheck} href="javascript:void(0)">
          Thank You
        </a>
      </nav>
      ...
      {isBeeMovieCheck && (
        <div className="bees">
          <h3 className="bees__title">Please read through The Bee Movie script before continuing.</h3>
